...
class BookReadMenu extends StatefulWidget {
  ...
  @override
  _BookReaderMenuState createState() => _BookReaderMenuState();
}

class _BookReaderMenuState extends State<BookReadMenu>
  ...
  @override
  void didUpdateWidget(BookReadMenu oldWidget) {
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Text('${percentage.toStringAsFixed(1)}%',
              style: TextStyle(color: Colours.grey, fontSize: 12)),
        ],
      ),
    );
  }
    ...
    return Positioned(
      ...
      child: Column(
        children: <Widget>[
          buildProgressTipView(),
          Container(
            decoration: BoxDecoration(color: Colours.back, boxShadow: [
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          Image.asset(icon),
          SizedBox(height: 5),
          Text(title, style: TextStyle(fontSize: 12, color: Colours.divider)),
        ],
      ),
    );
  }
